...
router.route('/:commentId').patch(validateParams('commentId', true), validateBody(commentUpdateSchema), updateComment).delete(validateParams('commentId', true), deleteComment);
